...
import { Animated, Dimensions, FlatList, Image, Linking, Platform, Pressable, ScrollView, StyleSheet, useWindowDimensions } from "react-native";
...
export default function ModalScreen({ navigation, route }: ModalScreenProps<`Modal`>) {
